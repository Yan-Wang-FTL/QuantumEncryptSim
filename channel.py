...
class QuantumChannel:
    ...
    def send(self, state_vector):
        ...
        circ.compose(utility.bit_flip_encode_circ('a'), inplace=True)
        circ.compose(utility.bit_flip_encode_circ('b'), inplace=True)
        circ.compose(utility.bit_flip_encode_circ('c'), inplace=True)
    ...
    def receive(self):
        ...
        circ.compose(utility.bit_flip_recovery_circ('a'), inplace=True)
        circ.compose(utility.bit_flip_recovery_circ('b'), inplace=True)
        circ.compose(utility.bit_flip_recovery_circ('c'), inplace=True)
